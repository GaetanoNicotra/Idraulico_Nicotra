                            ...
                            <div className="carousel-inner">
                                ...
                                <div className="carousel-item active">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave11.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania1" />
                                    </div>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave2.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania2" />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave4.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania4" />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave5.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania5" />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave6.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania6" />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave8.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania8" />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave12.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania12" />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                            <h5>Impianto di riserva</h5>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="public/imgs/imgs_autoclavi/img_idraulica_autoclave14.jpg" className="d-block carousel-img rounded" alt="img-impianti-catania14" />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                            <h5>Autoclave</h5>
