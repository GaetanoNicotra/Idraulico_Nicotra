                        ...
                        <div className="carousel-inner" id="bagni">
                            ...
                            <div className="carousel-item active">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni7.jpeg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni2.jpg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                                        <h5>Mobile bagno</h5>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni3.jpg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni5.jpg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                                        <h5>Lavabo doppio</h5>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni8.jpeg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni11.jpeg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni12.jpg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni13.jpg" className="d-block carousel-img rounded" id='img-house-wood' alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni10.jpg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
                            ...
                            <div className="carousel-item">
                                <div className='d-flex justify-content-center'>
                                    <img src="/imgs/imgs_bagni/img_idraulico_bagni14.jpg" className="d-block carousel-img rounded" alt='Immagini-bagni' />
                                </div>
                                <div className="carousel-caption-ouside mt-4 mb-4 d-md-block ">
                                    <div className='carousel-description'>
