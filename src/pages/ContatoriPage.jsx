                            ...
                            <div className="carousel-inner">
                                ...
                                <div className="carousel-item active">
                                    <div className='d-flex justify-content-center'>
                                        <img src="/imgs/img_contatori/img_idraulico_contatori3.jpg" className="d-block carousel-img rounded" alt='Contatori-idrici' />
                                    </div>
                                ...
                                <div className="carousel-item ">
                                    <div className='d-flex justify-content-center'>
                                        <img src="/imgs/img_contatori/img_idraulico_contatori1.jpg" className="d-block carousel-img rounded" alt='Contatori-idrici' />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                ...
                                <div className="carousel-item">
                                    <div className='d-flex justify-content-center'>
                                        <img src="/imgs/img_contatori/img_idraulico_contatori2.jpg" className="d-block carousel-img rounded" alt='Contatori-idrici' />
                                    </div>
                                    <div className="carousel-caption-outside mt-4 mb-4 d-md-block ">
                                        <div className='carousel-description'>
                                            <h5>Contatori</h5>
