    ...
    return (
        <>
            <div className="container py-5">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 d-flex">
                        <img src="src\assets\imgs\img_home\imgHome.jpg" alt="jumbotron" className='jumbotron w-75 rounded' />
                    </div>

                    <div className='col-lg-6 col-md-6 col-sm-12 px-5'>
                        <h4 className='divisore pb-4'>Chi siamo</h4>
                        <p>
            ...
            <div className="container mb-5">
                <div className="row">
                    <div className="col-lg-12"><h4 className="mb-4 mt-5 pb-4" id='divisore'>Dove trovarci</h4></div>
